...
<channel name="xfce4-panel" version="1.0">
  ...
  <property name="plugins" type="empty">
    ...
    <property name="plugin-19" type="string" value="genmon">
      <property name="command" type="string" value="/usr/local/bin/switch-sensors"/>
      <property name="enable-label" type="bool" value="false"/>
      <property name="update-period" type="int" value="2000"/>
      <property name="use-font" type="bool" value="false"/>
    </property>
